...
class Lot(models.Model):
    ...
    front_footage = models.CharField("Metragem frente", max_length=100, blank=True, null=True)
    bottom_footage = models.CharField("Metragem fundo", max_length=100, blank=True, null=True)
    right_footage = models.CharField("Metragem direita", max_length=100, blank=True, null=True)
    left_footage = models.CharField("Metragem esquerda", max_length=100, blank=True, null=True)
    corner_footage = models.CharField("Metragem esquina", max_length=100, blank=True, null=True)
    front_confrontation = models.CharField("Confrontação frente", max_length=100, blank=True, null=True)
    bottom_confrontation = models.CharField("Confrontação fundo", max_length=100, blank=True, null=True)
